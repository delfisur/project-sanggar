...
class Pengembalian(models.Model):
    ...
    penyewaan_ids = fields.One2many(comodel_name='delfisanggar.penyewaan', inverse_name='dikembalikan_id', string='List penyewaan')
    ...
    surat_penyewaan = fields.Boolean(string='Kwitansi')
    ...
    def _compute_jaminan(self):
        for rec in self:
            rec.kembali_jaminan = rec.kode_id.jaminan
